...
Repeating the rate-matched analysis with the **empirical Beliveau Cimbi-36 5-HT₂A map** (in place of the synthetic gradient) reproduced the result: combination ΔLZc = +2.4%, Δintegration = −75%, confirming the dissociation verdict with real receptor data (§5, limitation 1).
...
*Note: author list for ref. 4 (Deco et al. 2018) follows the canonical Current Biology record; verify ordering against the publisher page before final submission. All DOIs verified June 2026.*
